...
def default():
    ...
    if request.method == "POST":
        ...
        if file and allowed_file(file.filename):
            ...
            image_to_predict = cv2.imread(filename, cv2.IMREAD_GRAYSCALE)
            image_to_predict = image_to_predict/255.
            image_to_predict = cv2.resize(image_to_predict, (WIDTH,HEIGHT))
            image_to_predict = image_to_predict.reshape(-1,WIDTH,HEIGHT,1)
